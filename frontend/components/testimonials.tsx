...
import { defaultHomePage, type CmsTestimonials } from "@/lib/cms/site"
...
export function Testimonials({
  content = defaultHomePage.testimonials,
}: {
  content?: CmsTestimonials
}) {
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-celadon/90">{content.body}</p>
        </div>
